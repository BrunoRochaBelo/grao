  ...
  const placeholdersByChapter: Record<string, PlaceholderTemplate[]> = {
    "1": [
      ...
      },
      {
        ...
        name: "O Grande Dia",
        icon: "🎉",
        description: "Detalhes do nascimento",
        templateType: "primeira-vez",
        ageRangeStart: 0,
        isCompleted: true,
        momentId: "1",
      ...
      },
      {
        ...
        name: "Primeira Noite",
        icon: "🌙",
        description: "Como foi dormir juntos",
        templateType: "nota",
        ageRangeStart: 0,
        isCompleted: true,
      },
      {
        ...
        icon: "🚪",
        description: "Quem veio conhecer",
        templateType: "primeira-vez",
        ageRangeStart: 0,
        isCompleted: false,
      },
    ...
    "2": [
      ...
      },
      {
        ...
        name: "Engatinhar",
        icon: "🐛",
        description: "Primeiros movimentos",
        templateType: "primeira-vez",
        ageRangeStart: 210,
        isCompleted: false,
      },
    ...
    "3": [
      // Saúde & Crescimento
      {
        ...
        icon: "🩺",
        description: "Primeira ida ao pediatra",
      ...
      },
      {
        ...
        icon: "💉",
        description: "Pentavalente, VIP, Rotavírus",
        templateType: "vacina",
        ageRangeStart: 60,
        isCompleted: true,
      },
      ...
      },
      {
        ...
        icon: "💉",
        description: "Terceira dose + Influenza",
        templateType: "vacina",
        ageRangeStart: 180,
        isCompleted: true,
      },
    ...
    "6": [
      ...
      },
      {
        ...
        name: "Carta dos Pais",
        icon: "❤️",
        description: "Palavras de amor e conselhos",
        templateType: "carta",
        ageRangeStart: 0,
        isCompleted: false,
      },
      {
        ...
        name: "Carta dos Avós",
        icon: "👵",
        description: "Recordações e carinho",
        templateType: "carta",
        ageRangeStart: 0,
        isCompleted: false,
      },
      {
        ...
        icon: "📦",
        description: "Fotos e memórias guardadas",
        templateType: "nota",
        ageRangeStart: 0,
        isCompleted: false,
      },
